...
public class EnemyInfo : ScriptableObject
{
    ...
    [SerializeField] private bool hasRandomFiringRate;  // 랜덤 발사속도를 가지는지
    public bool HasRandomFiringRate => hasRandomFiringRate;
    [SerializeField] private float firingRate;  // 발사 속도
    public float FiringRate => firingRate;
    [SerializeField] private float minFR, maxFR;    // 랜덤 발사일 때 발사 속도 최대, 최저값
    public float MinFiringRate => minFR;
    public float MaxFiringRate => maxFR;

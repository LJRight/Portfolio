...
public class UIManager : MonoBehaviour
{
    ...
    string defaultEndingText = "Game Over";
    string clearEndingText = "Game Clear";
    string defaultEndingScoreText = "Your Score : ";
    ...
    public void SetEndingScoreText(int value, bool isClear)
    {
        gameOverText.text = isClear ? clearEndingText : defaultEndingText;
        endingScoreText.text = defaultEndingScoreText;
    ...
    public void OnGameOverSceneLoaded(bool isClear)
    {
        joyStick.gameObject.SetActive(false);
        SetEndingScoreText(ScoreKeeper.Instance.Score, isClear);
        MainMenuPanelActive(false);
        InGameUIPanelActive(false);
